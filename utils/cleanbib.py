...
def clean_bibfile(bib_file: Path | str, clean_bib_file: Path | str, verbose: bool = True):
    """
...
#   - either manually as a list of strings
...
#   list of input arguments I'd use if I called it from the terminal
#       read_cli_args(['myinputfile.txt', 'myoutput.txt'])
def read_cli_args(argv=None):
    """
